...
if x == 0 or y == 0:
    print('Введите ненулевые значение')
    exit(0)

if ( x > 0) and (y > 0): print("Четверть 1")
elif ( x < 0) and (y > 0): print("Четверть 2")
elif ( x < 0) and (y < 0): print("Четверть 3")
elif ( x > 0) and (y < 0): print("Четверть 4")